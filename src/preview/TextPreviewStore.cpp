...
bool TextPreviewStore::isCandidatePath(const QString& path) {
    ...
    static const QSet<QString> suffixes = {
        ...
        QStringLiteral("log"), QStringLiteral("json"), QStringLiteral("jsonc"),
        ...
        QStringLiteral("less"), QStringLiteral("js"), QStringLiteral("mjs"),
        QStringLiteral("cjs"), QStringLiteral("ts"), QStringLiteral("tsx"),
        QStringLiteral("jsx"), QStringLiteral("vue"), QStringLiteral("svelte"),
        QStringLiteral("py"), QStringLiteral("pyi"), QStringLiteral("c"),
        QStringLiteral("cc"), QStringLiteral("cpp"), QStringLiteral("cxx"),
        QStringLiteral("h"), QStringLiteral("hh"), QStringLiteral("hpp"),
        QStringLiteral("hxx"), QStringLiteral("rs"), QStringLiteral("go"),
        QStringLiteral("java"), QStringLiteral("kt"), QStringLiteral("kts"),
        QStringLiteral("swift"), QStringLiteral("sh"), QStringLiteral("bash"),
        QStringLiteral("zsh"), QStringLiteral("fish"), QStringLiteral("sql"),
        QStringLiteral("csv"), QStringLiteral("tsv"), QStringLiteral("properties"),
        QStringLiteral("desktop"), QStringLiteral("service"), QStringLiteral("socket"),
        QStringLiteral("timer"), QStringLiteral("target"), QStringLiteral("mount"),
        QStringLiteral("path"), QStringLiteral("cmake"), QStringLiteral("gradle"),
        QStringLiteral("nix"), QStringLiteral("lua"), QStringLiteral("qml"),
    };
