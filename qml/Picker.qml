...
Window {
    ...
    Shortcut {
        sequence: "Escape"
        enabled: !location.activeFocus && !filter.activeFocus
                ...
                TextInput {
                    ...
                    onAccepted: {
                        if (!root.session)
                            return
                        if (text.indexOf("://") >= 0) {
                            root.locationError = "Picker Phase A supports local folders only"
            ...
            delegate: Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: function(event) {
                        ...
                        if (!Picker.multiple || Picker.folderMode) {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text {
                    ...
                    color: root.canAccept && root.locationError === "" && Picker.error === ""
                        ? Ryoku.inkMuted
                        : Ryoku.sun
                    font.family: Ryoku.uiFont
                    font.pixelSize: 9 * root.u
            ...
            Row {
                ...
                Rectangle {
                    id: acceptButton
                    readonly property bool enabledState: root.canAccept
